            ...
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-secondary mb-1"><?php echo $customer['addressLine1'] ?></p>
                        <p class="text-muted font-size-sm"><?php echo $customer['city'] ?></p>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        <?php echo $customer['addressLine2'] ?>
